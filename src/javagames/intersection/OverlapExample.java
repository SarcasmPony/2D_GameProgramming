...
public class OverlapExample extends SimpleFramework
{
            ...
            Vector2f c, float r, Vector2f min, Vector2f max)
    {
        ...
        if(c.x < min.y) d += (c.y - min.y)*(c.y - min.y);
    ...
    protected void render(Graphics g)
    {
        ...
        g.drawString("Mouse Delta x: " +mouseDelta.x +"y: " +mouseDelta.y, 20, 80);
        //render objects
    ...
    private void drawOval(Graphics g, Vector2f center, float radius)
    {
        ...
        int circleHeight = (int)(bottomRight.y - topLeft.y); //may contain a bug
